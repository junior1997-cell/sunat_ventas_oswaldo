...
function comprobantes(){
	...
	var fila6='<tr class="filas" id="fila">'+
        '<td><input style="text-align:center; width: 150px;" type="text" name="nombreSucursal[]" id="nombreSucursal[]" value="Orden Compra"></td>'+
        '<td><input style="text-align:center; width: 80px;" type="text" name="serie[]" id="serie[]" value="000"></td>'+    
        '<td><input style="text-align:center; width: 80px;" type="text" name="numero[]" id="numero[]" value="9999999"></td>'+
		'</tr>';

		$('#detalles').append(fila + fila1 + fila2 + fila3 + fila4 + fila5 + fila6);
