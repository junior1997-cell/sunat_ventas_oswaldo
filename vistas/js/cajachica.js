...
function mostrarCaja(){
	...
	$.post("../controladores/consultas.php?op=mostrarTotalBoletasTCaja",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalFacturasCaja",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalFacturasTCaja",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalNotasVentaCaja",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalNotasVentaTCaja",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalCuentasCobrarVentaCaja",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalCuentasCobrarVentaTCaja",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalEfectivo",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalTransferencia",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalIngresos",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=mostrarTotalEgresos",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=totalFacturas",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=totalBoletas",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=totalNotas",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
	...
	$.post("../controladores/consultas.php?op=totalCuentas",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idsucursal : idsucursal}, function(data,status)
	{
