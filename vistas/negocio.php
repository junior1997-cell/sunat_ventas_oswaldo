                ...
                <div class="panel-body" id="formularioregistros">
                  <form action="" name="formulario" id="formulario" method="POST">
                    <div class="row p-x-15px">
                      ...
                      <div class="card col-lg-12 p-y-5px" style="box-shadow: 0 0 1px rgb(0 0 0), 0 1px 3px rgb(0 0 0 / 60%);">
                        <div class="row p-5px">
                      ...
                      <div class="col-lg-12 m-2 m-t-10px">
                      ...
                      <!-- ./card - col-12 -->
                      <div class="col-lg-12 m-2 m-t-10px">
                        <div class="text-primary"><label for="">Usuario y Password SOL - SUNAT</label></div>
                      </div>
                      <div class="card col-lg-12 p-y-5px" style="box-shadow: 0 0 1px rgb(0 0 0), 0 1px 3px rgb(0 0 0 / 60%);">
                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                      ...
                      <div class="col-lg-12 m-2 m-t-10px">
                        <div class="text-primary"><label for="">Certificado Electrónico y Password</label></div>
                      </div>
                      <div class="card col-lg-12 p-y-5px" style="box-shadow: 0 0 1px rgb(0 0 0), 0 1px 3px rgb(0 0 0 / 60%);">
                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
