<?php
//Activamos el almacenamiento en el bufferlistar
ob_start();
session_start();
          ...
          <div class="panel-body table-responsive" class="box-body" id="listadoregistros">
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-3 col-xs-12">
              ...
              <div class="input-group">
                ...
                <select id="idsucursal2" name="idsucursal2" class="form-control selectpicker" data-live-search="true" onchange="selectComprobante();">
                </select>
              </div>
            </div>
          ...
          <div class="panel-body" id="formularioregistros">
            <form name="formulario" id="formulario" method="POST">
              ...
              <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-file"></i></span>
                  <select name="tipo_c" id="tipo_c" class="form-control selectpicker" onchange="cambiar();">
        ...
        <div class="modal-content">
          ...
          <form class="form-horizontal" role="form" name="formularioGuardarImagen" id="formularioGuardarImagen" method="POST">
            ...
            <div class="modal-header" style="background:#3c8dbc; color:white">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="limpiarImagen()">&times;</button>
            ...
            <div class="modal-footer">
              <button type="button" onclick="limpiarImagen()" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-times"></i> Cerrar</button>
