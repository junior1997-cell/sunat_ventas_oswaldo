...
if ($conexion) {
  ...
  $client->setTipoDoc($tdClie)
    ...
    ->setRznSocial(mb_convert_encoding($clien, 'UTF-8', mb_detect_encoding($clien, "UTF-8, ISO-8859-1, ISO-8859-15", true)));
  ...
  if ($almacen) {
    foreach ($almacen as $column) {
      ...
      $Distrito = mb_convert_encoding($column['distrito'], 'UTF-8', mb_detect_encoding($column['distrito'], "UTF-8, ISO-8859-1, ISO-8859-15", true));
      $Provincia = mb_convert_encoding($column['provincia'], 'UTF-8', mb_detect_encoding($column['provincia'], "UTF-8, ISO-8859-1, ISO-8859-15", true));
      $Departamento = mb_convert_encoding($column['departamento'], 'UTF-8', mb_detect_encoding($column['departamento'], "UTF-8, ISO-8859-1, ISO-8859-15", true));
      $Direccion = mb_convert_encoding($column['direccion'], 'UTF-8', mb_detect_encoding($column['direccion'], "UTF-8, ISO-8859-1, ISO-8859-15", true));
    }
  }
  ...
  foreach ($resultado2 as $column) {
    ...
    if ($column['nombreProd'] == "BOLSA") {
      ...
      $item->setCodProducto($column['COD'])
        ...
        ->setDescripcion(mb_convert_encoding($column['nombreProd'], 'UTF-8', mb_detect_encoding($column['nombreProd'], "UTF-8, ISO-8859-1, ISO-8859-15", true)))
