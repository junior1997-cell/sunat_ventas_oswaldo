...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['compras'] == 1) {
    ...
    $pdf->addSociete(
      mb_convert_encoding($empresa, 'UTF-8', mb_detect_encoding($empresa, "UTF-8, ISO-8859-1, ISO-8859-15", true)),
      mb_convert_encoding("", 'UTF-8', mb_detect_encoding("", "UTF-8, ISO-8859-1, ISO-8859-15", true)) . 
      mb_convert_encoding($documento, 'UTF-8', mb_detect_encoding($documento, "UTF-8, ISO-8859-1, ISO-8859-15", true)) . "\n" .
      mb_convert_encoding("", 'UTF-8', mb_detect_encoding("", "UTF-8, ISO-8859-1, ISO-8859-15", true)) . 
      mb_convert_encoding($direccion, 'UTF-8', mb_detect_encoding($direccion, "UTF-8, ISO-8859-1, ISO-8859-15", true)) . "\n" .
      mb_convert_encoding("Teléfono: ", 'UTF-8', mb_detect_encoding("Teléfono: ", "UTF-8, ISO-8859-1, ISO-8859-15", true)) . 
      $telefono . "\n" .
      "Email : " . $email,
      $logo,
      $ext_logo
    ...
    $pdf->addClientAdresse(mb_convert_encoding($regv->proveedor, 'UTF-8', mb_detect_encoding($regv->proveedor, "UTF-8, ISO-8859-1, ISO-8859-15", true)), "Domicilio: " . mb_convert_encoding($regv->direccion, 'UTF-8', mb_detect_encoding($column['nombreProd'], "UTF-8, ISO-8859-1, ISO-8859-15", true)), $regv->tipo_documento . ": " . $regv->num_documento);
